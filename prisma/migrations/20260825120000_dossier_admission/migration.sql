...
-- CreateEnum
CREATE TYPE "EvenementMembre" AS ENUM ('DOSSIER_SOUMIS', 'FICHE_MODIFIEE', 'DOSSIER_ACCEPTE', 'DOSSIER_RENVOYE_EN_CORRECTION', 'DOSSIER_REFUSE', 'AGE_MODIFIE', 'FONCTION_MODIFIEE', 'ACCES_MODIFIE');
